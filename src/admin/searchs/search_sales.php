...
echo '<div class="container-fluid d-flex" id="products-container">';
echo '<main class="flex-fill p-4 overflow-auto" id="main-content">';
echo ' <h2 class="text-center text-primary fw-bold mt-2">Ventas</h2>';
if ($result->num_rows > 0) {
    ...
    echo "<p class='text-center text-muted'>No se han encontrarón ventas.</p>";
}
echo ' </main>';
echo '</div>';
?>
